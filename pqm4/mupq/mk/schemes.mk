...
elf/$(2)_%.elf: NIST_KAT_RANDOMBYTES=$$(filter %_kat.elf, $$@)
...
tests: elf/$(2)_test.elf elf/$(2)_speed.elf elf/$(2)_hashing.elf elf/$(2)_stack.elf elf/$(2)_testvectors.elf elf/$(2)_kat.elf elf/$(2)_fi.elf
tests-bin: bin/$(2)_test.bin bin/$(2)_speed.bin bin/$(2)_hashing.bin bin/$(2)_stack.bin bin/$(2)_testvectors.bin bin/$(2)_kat.bin bin/$(2)_fi.bin
tests-hex: bin/$(2)_test.hex bin/$(2)_speed.hex bin/$(2)_hashing.hex bin/$(2)_stack.hex bin/$(2)_testvectors.hex bin/$(2)_kat.hex bin/$(2)_fi.hex

$(call schemename,$(1)): elf/$(2)_test.elf elf/$(2)_speed.elf elf/$(2)_hashing.elf elf/$(2)_stack.elf elf/$(2)_testvectors.elf elf/$(2)_kat.elf elf/$(2)_fi.elf
$(call schemename,$(1))-bin: bin/$(2)_test.bin bin/$(2)_speed.bin bin/$(2)_hashing.bin bin/$(2)_stack.bin bin/$(2)_testvectors.bin bin/$(2)_kat.bin bin/$(2)_fi.bin
$(call schemename,$(1))-hex: bin/$(2)_test.hex bin/$(2)_speed.hex bin/$(2)_hashing.hex bin/$(2)_stack.hex bin/$(2)_testvectors.hex bin/$(2)_kat.hex bin/$(2)_fi.hex
